...
15. Return a schema-v6 StorylineDefinitionInput containing id, title, setting, story, clueDecks, acts, and setupRequirements. Preserve every stable setting resource ID and pass the result through createStorylineDefinition before constructing a runtime.`
}
