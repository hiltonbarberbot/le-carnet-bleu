...
export function simulateStorylinePlaythrough(definition: StorylineDefinition): StorylinePlayabilityReport {
  ...
  try {
    ...
    return {
      ...
      verdict: 'pass',
      summary: `Playable through ${trace.length} public commands across opening, investigation, both resolutions, reveal and scoring.`,
      trace,
      coverage,
      failure: null,
    }
    ...
    return {
      ...
      definitionFingerprint: definition.fingerprint,
      verdict: 'fail',
      summary: `Deterministic playthrough stopped at ${failure.checkpoint}.`,
      trace,
      coverage,
      failure,
    }
