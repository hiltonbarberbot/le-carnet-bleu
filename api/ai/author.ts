...
const shape = `Return one JSON object with exactly this shape (never include fingerprint or schemaVersion):
{
  ...
  "story": {
    ...
    "evening": [
      { "id": "arrival-stage", "title": "", "description": "introduce the cast", "durationMinutes": 5, "phase": "single-opening-act-id" },
      { "id": "incident-stage", "title": "", "description": "stage the incident and discover the body", "durationMinutes": 10, "phase": "single-opening-act-id" },
